...
function addElement(){
    ...
    //unshift-> adds element from the <front>
...
function student(){
    ...
    const student = {
        name: "Sumaya",
        age: 17,
        email: "sumaya.yonkaal",
        studentNumber: "ms.4355644",
        iskenya: false
    }
    const computer = {
        "laptop.model !27chp"
...
// display value
// print(`User:`, user())
const num = details.course.number
